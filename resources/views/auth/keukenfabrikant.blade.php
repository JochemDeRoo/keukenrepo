        ...
        <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/aanvragen">
                        ...
                        <div class="form-group row">
                            <label for="bedrijfsnummer" class="col-md-4 col-form-label text-md-right">Bedrijfsnummer</label>

                            <div class="col-md-6">
                                <input id="bedrijfsnummer" type="text" class="custom-input" placeholder="Bedrijfsnummer..." name="bedrijfsnummer" required autocomplete="name" autofocus>
